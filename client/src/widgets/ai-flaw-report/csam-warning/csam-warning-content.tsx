          ...
          <FormItem className="bg-error-100 flex items-center border-none p-0">
            <FormControl>
              <Checkbox
                ...
                className="border-black bg-white data-[state=checked]:bg-gray-900 dark:bg-white"
              />
            </FormControl>
            <FormLabel className="text-error-950 cursor-pointer text-sm font-normal">
              I understand that I cannot submit any material depicting CSAM as
              evidence through this form. I can only report the occurrence of
              the incident.
            </FormLabel>
          </FormItem>
        )}
