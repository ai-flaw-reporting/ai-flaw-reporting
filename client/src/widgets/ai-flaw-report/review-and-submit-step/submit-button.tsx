...
export function SubmitButton() {
  ...
  return (
    <>
      <Button
        type="button"
        className="text-md min-h-11 w-full cursor-pointer bg-gray-900 py-2.5 font-semibold text-white hover:bg-gray-800 disabled:cursor-not-allowed disabled:bg-gray-300"
