...
import { MobileInfoSections } from "./_components/mobile-info-sections";
...
export default async function ResourcesPage({ searchParams }: PageProps) {
  ...
  return (
    <main className="bg-gray-100">
      ...
      >
        <div className="mx-auto flex max-w-[1344px] flex-col items-center gap-8 px-4 md:px-8">
          <header className="flex flex-col items-center gap-2 pt-8 md:gap-[31px]">
            <div className="flex max-w-[555px] flex-col items-center gap-2">
              <h1
                id="resources-title"
                className="display-sm text-center font-bold text-gray-800"
              >
                <span className="hidden md:inline">Report </span>Resources
              </h1>
              <p className="md:text-md text-center text-sm text-gray-600 md:leading-[23px]">
