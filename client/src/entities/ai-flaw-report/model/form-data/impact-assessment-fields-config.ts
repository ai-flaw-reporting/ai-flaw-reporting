...
export const SEVERITY_OF_HARM_FIELD = {
  ...
  label: "How bad the harm would be if someone hits this flaw?",
  options: [
    "not_sure",
    "negligible",
    "low",
  ...
  descriptions: {
    not_sure:
      "The selected level means that you are not familiar on the severity of the impact.",
    negligible: "",
    low: "",
    medium: "",
    high: "",
...
export const PREVALENCE_FIELD = {
  ...
  descriptions: {
    not_sure:
      "The selected level means that you are not familiar on the prevalence of the impact.",
    isolated: "",
  ...
  options: [
    {
      ...
      label: "Documented Weakness",
      description: "The weakness matches an existing category in ",
    },
    {
      value: HARM_OPTION_VALUE.NEW,
      label: "New Weakness",
      description: "The weakness is not already a category in ",
    },
  ] as const,
};
  ...
  options: [
    {
      ...
      description: "Noticed during regular use of the system",
    },
    {
      value: "monitoring",
      label: "Monitoring",
      description: "Detected through system or performance monitoring",
    },
    {
      value: "testing",
      label: "Testing",
      description: "Found during research, testing, or evaluation",
    },
    {
      value: "external_report",
      label: "External Report",
      description: "Reported by an external party or organization",
    },
    {
      value: "automated_analysis",
      label: "Automated Analysis",
      description: "Identified by automated tools or analysis pipelines",
    },
  ] as const,
};
