...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'AI system flaw and vulnerability reports';
    displayName: 'AI Flaw Report';
    pluralName: 'reports';
    singularName: 'report';
  };
  options: {
  ...
  attributes: {
    classify_csamAcknowledgment: Schema.Attribute.Boolean;
    classify_csamInvolved: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    classify_maliciousUse: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    classify_realWorldHarm: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    disclosure_publicDisclosureIntent: Schema.Attribute.Enumeration<
      ['yes', 'no', 'undecided', 'already']
    > &
      Schema.Attribute.Required;
    evidence_attachments: Schema.Attribute.Media<
      'images' | 'files' | 'videos',
      true
    >;
    evidence_proofOfConcept: Schema.Attribute.Text;
    evidence_stepsToReproduce: Schema.Attribute.Text;
    ...
    incident_issueDescription: Schema.Attribute.Text &
      Schema.Attribute.Required;
    incident_policyViolationReason: Schema.Attribute.Text;
    incident_policyViolationUrl: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::report.report'
    > &
      Schema.Attribute.Private;
    metadata_createdAt: Schema.Attribute.DateTime;
    metadata_reportType: Schema.Attribute.String;
    metadata_schemaVersion: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    reporter_country: Schema.Attribute.String;
    reporter_email: Schema.Attribute.Email & Schema.Attribute.Required;
    reporter_org: Schema.Attribute.String;
    review_disclosureDatepicker: Schema.Attribute.DateTime;
    review_disclosureTimeline: Schema.Attribute.String;
    review_embargoDetails: Schema.Attribute.String;
    review_publicDisclosureIntent: Schema.Attribute.Enumeration<
      ['yes', 'no', 'undecided', 'already']
    >;
